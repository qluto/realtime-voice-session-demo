export const ICF_CORE_COMPETENCIES = `# Updated ICF Core Competencies

Released October 2019
rev. 07.30.21

Following a rigorous, 24-month coaching practice analysis, the International
Coach Federation is announcing an updated ICF Coaching Core Competency
Model. This competency model is based on evidence collected from more than
1,300 coaches across the world, including both ICF Members and non-members
and representing a diverse range of coaching disciplines, training backgrounds,
...
ago, remains critically important to the practice of coaching today. Some new
elements and themes that emerged from the data have also been integrated into
the model. These include a paramount emphasis on ethical behavior and
confidentiality, the importance of a coaching mindset and ongoing reflective
practice, the critical distinctions between various levels of coaching agreements,
the criticality of partnership between coach and client, and the importance of
cultural, systemic and contextual awareness. These foundational components,
combined with emerging themes, reflect the key elements of coaching practice
today and will serve as stronger, more comprehensive coaching standards for the
future. The ICF updated Core Competency model will go into effect in the second
half of 2021.

## A. Foundation
### 1. Demonstrates Ethical Practice
Definition: Understands and consistently applies coaching ethics and
...
Definition: Develops and maintains a mindset that is open, curious,
...
Definition: Partners with the client and relevant stakeholders to create
clear agreements about the coaching relationship, process, plans and
goals. Establishes agreements for the overall coaching engagement as
well as those for each coaching session.
...
relationship, what is and is not being offered, and the
responsibilities of the client and relevant stakeholders
3. Reaches agreement about the guidelines and specific parameters
of the coaching relationship such as logistics, fees, scheduling,
duration, termination, confidentiality and inclusion of others
4. Partners with the client and relevant stakeholders to establish an
...
7. Partners with the client to define what the client believes they
need to address or resolve to achieve what they want to
accomplish in the session
8. Partners with the client to define or reconfirm measures of
success for what the client wants to accomplish in the coaching
engagement or individual session
9. Partners with the client to manage the time and focus of the
session
10. Continues coaching in the direction of the client's desired
outcome unless the client indicates otherwise
11. Partners with the client to end the coaching relationship in a way
that honors the experience

### 4. Cultivates Trust and Safety
Definition: Partners with the client to create a safe, supportive
environment that allows the client to share freely. Maintains a
...
3. Acknowledges and respects the client's unique talents, insights
...
6. Demonstrates openness and transparency as a way to display
vulnerability and build trust with the client

### 5. Maintains Presence
Definition: Is fully conscious and present with the client, employing a
style that is open, flexible, grounded and confident
1. Remains focused, observant, empathetic and responsive to the
client
...
4. Asks questions that help the client explore beyond current
thinking
...
11. Shares observations, insights and feelings, without attachment,
that have the potential to create new learning for the client
...
3. Acknowledges and supports client autonomy in the design of
goals, actions and methods of accountability
...
6. Partners with the client to summarize learning and insight within
or between sessions
