export function ConfigSidebar() {
  return (
    <>
      <aside id="config-sidebar" className="config-sidebar is-open" aria-hidden="false" aria-labelledby="config-sidebar-title">
        <div
        ...
        >
          <header className="config-sidebar-header">
            ...
            <button id="config-close-btn" type="button" className="config-sidebar-close" aria-label="設定メニューを閉じる">
              ✕
            </button>
          </header>
          <div className="config-sidebar-body" id="config-sidebar-body">
            <section className="coach-calibrator">
              ...
              <form id="coach-calibrator" className="coach-calibrator-form">
              ...
              <div className="coach-recommendation" id="coach-recommendation">
                <p className="coach-recommendation-label">
                  推奨スタイル: <span id="coach-recommendation-label">ウォーム&プロフェッショナル</span>
                </p>
                <p id="coach-recommendation-description" className="coach-recommendation-description">
                  回答すると、もっとも相性の良いコーチスタイルをご案内します。
                </p>
                <p id="coach-recommendation-rationale" className="coach-recommendation-rationale" style={{ display: 'none' }}></p>
              </div>
            </section>
      ...
      <div id="config-sidebar-backdrop" className="config-sidebar-backdrop is-open" aria-hidden="true"></div>
    </>
  )
}
